        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a
                href="https://www.instagram.com/bari.trekking"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 p-3 rounded-full hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 transition-all group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 p-3 rounded-full hover:bg-green-500 transition-all group"
                aria-label="WhatsApp"
              >
                <svg
