    ...
    >
      ...
      <Container className="relative z-10 text-center px-4">
        <motion.div
          ...
          className="space-y-4 md:space-y-8  mx-auto flex flex-col items-center mb-8 lg:mb-0"
        >
          <motion.div
          ...
          <motion.h1
            ...
            className=" md:text-6xl text-[33px] font-heading font-bold text-white tracking-tight drop-shadow-2xl leading-tight w-full flex flex-col items-center uppercase drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] gap-2"
          >
          ...
          <motion.div variants={itemVariants} whileHover={{ scale: 1.05 }}>
            <Button
              className="bg-bari-orange hover:bg-bari-orange/90 text-white font-bold text-lg px-8 py-4 rounded-full w- md:w-auto min-h-[48px] shadow-lg lg:hidden mt-12"
