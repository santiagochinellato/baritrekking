...
const faqs = [
  {
    title: "¿Necesito experiencia previa para sumarme?",
    content:
  ...
  {
    title: "¿Cómo son las salidas de trekking?",
    content:
  ...
  {
    title: "¿Qué incluye la Membresía Social de $5.000?",
    content:
    ...
    <section id="faq" className="py-24 bg-white">
      <Container className="max-w-4xl">
        ...
        >
          ...
          <p className="text-bari-slate text-lg">
